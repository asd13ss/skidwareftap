...
local Library = {
    ...
    --// Background Image \\--
    BackgroundImageUrl = "", -- URL or rbxassetid:// for background image
    BackgroundImageTransparency = 0.4, -- transparency of background image (0 = opaque, 1 = invisible)
    BackgroundImageOverlay = true, -- semi-transparent overlay for text readability
...
function Library:SetFont(FontFace)
    ...
    elseif typeof(FontFace) == "string" then
        FontFace = Font.fromName(FontFace)
    end
...
function Library:CreateWindow(WindowInfo)
    ...
    elseif typeof(WindowInfo.Font) == "string" then
        WindowInfo.Font = Font.fromName(WindowInfo.Font)
    end
    ...
    do
        ...
        --// Determine if we're using a background image from Library.BackgroundImageUrl
        local UseBgImage = Library.BackgroundImageUrl and Library.BackgroundImageUrl ~= ""
        ...
        --// Background Image Support (from URL or asset)
        if UseBgImage then
            -- The actual background image
            BackgroundImage = New("ImageLabel", {
                Image = Library.BackgroundImageUrl,
